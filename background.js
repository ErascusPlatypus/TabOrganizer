...
//                     // Create a new window for each topic
//                     windowPromises.push(new Promise((resolve) => {
//                         chrome.windows.create({ focused: true }, (newWindow) => {
//                             const tabIdsToMove = tabGroup.map(tab => tab.id);
    
//                             chrome.tabs.move(tabIdsToMove, { windowId: newWindow.id, index: -1 }, () => {
//                                 resolve();
//                             });
//                         });
//                     }));
...
//                 // Wait for all windows to be created and tabs moved
//                 Promise.all(windowPromises)
//                     .then(() => {
//                         console.log("Tabs moved to respective windows successfully.");
//                     })
//                     .catch(error => {
//                         console.error('Error moving tabs to windows:', error);
//                     });
//             })
